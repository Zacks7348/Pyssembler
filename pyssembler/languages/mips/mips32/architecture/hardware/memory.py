from pyssembler.languages.mips.common.architecture.hardware import MIPSMemory, MIPSMemorySegment, MIPSTextMemorySegment
from pyssembler.languages.mips.common.architecture.mips_enums import Segment

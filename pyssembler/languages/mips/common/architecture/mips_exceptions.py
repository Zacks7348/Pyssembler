from pyssembler.core.architecture import ProgramException
...
class MIPSExceptionCodes:
    ...
    COPROCESSOR_UNUSABLE = 16  # Coprocessor unusable / not available
...
class CoprocessorUnusableException(MIPSException):
    """
    MIPS Exception raised when an instruction attempts to access a coprocessor that is not enabled.
    """

    def __init__(self) -> None:
        super().__init__('Coprocessor Unusable', MIPSExceptionCodes.COPROCESSOR_UNUSABLE)
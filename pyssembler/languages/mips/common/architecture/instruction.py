...
from . import assembler_errors, mips_enums, mips_exceptions
from .cpu import MIPSCPU
from .mips_token import MIPSToken
from pyssembler.core.architecture import ProgramDroppedOff, PyssemblerBasicInstruction
...
class MIPSBasicInstruction(PyssemblerBasicInstruction[MIPSCPU]):
